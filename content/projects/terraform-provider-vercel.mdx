...
date: "2021-03-16"
repository: adrianoleao/terraform-provider-vercel
url: https://registry.terraform.io/providers/adrianoleao/vercel/latest
published: true
---
...
I needed to manage my Vercel skills and especially sync environment variables from different cloud providers.
...
terraform {
  required_providers {
    vercel = {
      source  = "registry.terraform.io/adrianoleao/vercel"
      version = ">=0.10.3"
    }
  }
}
...
resource "vercel_project" "my_project" {
  ...
  git_repository {
    type = "github"
    repo = "adrianoleao/terraform-provider-vercel"
  }
}
```
...
Now that Vercel have stepped in, I have decided to [deprecate](https://twitter.com/adrianoleao_/status/1517759708983177218) this one on April 23rd 2022. 
